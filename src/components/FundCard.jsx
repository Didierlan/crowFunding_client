...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
    ...
    return (
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            <img src={image} alt={title} className=' w-full h-[158px] object-cover rounded-[20px] p-2' />
            ...
            <div className='flex flex-col p-4'>
                ...
                <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{remainingDays > 0 ? remainingDays : <p className='text-white font-epilogue font-semibold  bg-[#8c6dfd] rounded-[10px] px-[8px]  py-[3px] text-[11px]'>Finalized</p> }</h4>
